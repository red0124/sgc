...
#define INIT_LIST_HEADERS(T)                                                   \
        ...
        int list_equ_##T(struct list_##T *, struct list_##T *);                \
        ...
        T list_pop_back_##T(struct list_##T *);                                \
                                                                               \
        T list_front_##T(struct list_##T *);                                   \
        ...
        int list_find_##T(const struct list_##T *, const T);                   \
                                                                               \
        void list_operate_##T(const struct list_##T *,                         \
                              void (*operate)(void *));                        \
        void list_operate_inverted_##T(const struct list_##T *,                \
                                       void (*operate)(void *));               \
                                                                               \
        ...
        int list_is_sorted_##T(struct list_##T *,                              \
                               int (*comp)(const void *, const void *));       \
                                                                               \

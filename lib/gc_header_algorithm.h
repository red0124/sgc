...
#define INIT_HEADER_ITERATE(T, N)                                              \
...
#define INIT_HEADER_ITERATE_PAIR(K, V, N)                                      \
        void N##_fold_pair(                                                    \
            struct N##_iterator begin, struct N##_iterator end,                \
...
#define INIT_HEADER_WRITE_SELECT(T, N, ...)                                    \
...
#define INIT_HEADER_WRITE_PAIR_SELECT(K, V, N, ...)                            \

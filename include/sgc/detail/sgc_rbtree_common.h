...
#define _SGC_INIT_RBTREE_TYPE_FUNCTIONS(K, N)                                  \
    ...
    static struct _m_##N##_node* N##_sibling(const struct _m_##N##_node* const n,        \
        ...
        return sibling;                                                        \
                                                                               ...
                                                                               \
    static void _m_##N##_rotate_left(struct N* m, struct _m_##N##_node* parent,          \
        ...
        gparent->color_ = SGC_MAP_RED;                                         \
                                                                               ...
                                                                               \
    static void _m_##N##_rotate_right(struct N* m, struct _m_##N##_node* parent,         \
                                 struct _m_##N##_node* gparent) {                   \
        ...
        gparent->color_ = SGC_MAP_RED;                                         \
                                                                               ...
                                                                               \
    static void _m_##N##_rotate_left_right(struct N* m, struct _m_##N##_node* n,         \
        ...
        _m_##N##_rotate_right(m, n, gparent);                                       \
                                                                               ...
                                                                               \
    static void _m_##N##_rotate_right_left(struct N* m, struct _m_##N##_node* n,         \
                                      struct _m_##N##_node* parent,                 \
                                      struct _m_##N##_node* gparent) {              \
    ...
    static void _m_##N##_copy_nodes(struct N* __restrict__ dst,                     \
        ...
        if (src->size_ != 0) {                                                 \
            ...
            struct _m_##N##_node** stack_src =                                      \
                (struct _m_##N##_node**)sgc_malloc(_m_##N##_stack_size(src->size_));     \
                                                                               \
            struct _m_##N##_node* curr_src = src->root_;                            \
                                                                               \
            struct _m_##N##_node** stack_dst =                                      \
                (struct _m_##N##_node**)sgc_malloc(_m_##N##_stack_size(dst->size_));     \
                                                                               \

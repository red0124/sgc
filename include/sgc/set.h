...
#define _SGC_INIT_PRIVATE_SET_FUNCTION_DECLARATIONS(V, N)                      \
    ...
    static struct N##_node*                                               \
        N##_sibling(const struct N##_node* const n,                       \
                    const struct N##_node* const parent);                 \
    static void N##_rotate_left(struct N* s,                              \
                                     struct N##_node* parent,             \
                                     struct N##_node* gparent);           \
    static void N##_rotate_right(struct N* s,                             \
                                      struct N##_node* parent,            \
                                      struct N##_node* gparent);          \
    static void N##_rotate_left_right(struct N* s,                        \
                                           struct N##_node* n,            \
                                           struct N##_node* parent,       \
                                           struct N##_node* gparent);     \
    static void N##_rotate_right_left(struct N* s,                        \
                                           struct N##_node* n,            \
                                           struct N##_node* parent,       \
                                           struct N##_node* gparent);     \

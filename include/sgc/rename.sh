...
FILE="map.h set.h detail/sgc_rbtree_common.h"
KEYS=("N##_node" "N##_stack_size" "N##_is_left_child" "N##_rotate"\
...
REPLACEMENTS=("_m_##N##_node" "_m_##N##_stack_size" "_m_##N##_is_left_child" \
    "_m_##N##_rotate" "_m_##N##_correct" "_m_##N##_check" "_m_##N##_node_insert" \

...
#include "../lib/gc_static_vector.h"
...
INIT_STATIC_VECTOR(int, VECTOR_MAX, vector);
...
INIT_STATIC_VECTOR(al, VECTOR_MAX, avector);
...
INIT_STATIC_VECTOR(vector, VECTOR_MAX, vvector);

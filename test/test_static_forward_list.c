...
#include "../lib/static_forward_list.h"
#include "./Unity/src/unity.h"

#define TEST_ELEMENTS_NUM 50

SGC_INIT_STATIC_FORWARD_LIST(int, 100, list);
...
SGC_INIT_STATIC_FORWARD_LIST(al, 100, alist);
...
SGC_INIT_STATIC_FORWARD_LIST(list, 100, llist);
